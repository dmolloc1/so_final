interface DeleteConfirmModalProps {
  SucurNom: string; // ← Nota: está en PascalCase
  open: boolean;
  onClose: () => void;
  onConfirm: () => void;
  loading?: boolean;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-opacity-10 backdrop-blur-md">
      <div className="bg-white rounded-xl shadow-2xl border border-gray-200 w-[90%] max-w-md p-6 relative">
        ...
        <h2 className="text-lg font-bold text-gray-800 mb-2">Eliminar Sucursal</h2>
        <p className="text-sm text-gray-600 mb-6">
          ¿Está seguro de eliminar la sucursal <strong>{SucurNom}</strong>? {/* ← AQUÍ faltaba */}
        </p>
