...
const SupervisorDashboard: React.FC = () => {
  ...
  const branchId = user?.sucurCod; // Sucursal asignada al supervisor
  ...
  // Conectar WebSocket (sin cargar sucursales, usa la asignada)
  useEffect(() => {
    ...
    // Supervisor siempre usa su sucursal asignada
  ...
  }, [userId, branchId]); // Depende de branchId, no de selectedBranchId
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'}  p-2 mb-4`}>
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          {/* Sucursal e indicador de conexión */}
      ...
      {/* Resumen por Sucursal - NO se muestra para supervisores */}
    </div>
  );
};
