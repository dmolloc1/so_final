    ...
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {
                    'success': False,
                    'error': 'protected_delete',
                    'message': f'No se puede eliminar el proveedor "{business_name}"',
                    'detail': f'Este proveedor tiene {product_count} producto(s) asociado(s). Para eliminarlo, primero debes reasignar o eliminar los productos.',
